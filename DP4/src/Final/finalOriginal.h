...
#ifndef DP4_SRC_ORIGINAL_FINAL_H_
#define DP4_SRC_ORIGINAL_FINAL_H_
...
namespace final_original_file {	// Have not yet de-refactored to procedural & OOP code.
...
#endif /* DP4_SRC_ORIGINAL_FINAL_H_ */
